...
<div class="right">
    ...
    <div class="providerAdd">
        <form id="userForm" name="userForm" method="post"
              action="${pageContext.request.contextPath }/user/updatesave.html">
            ...
            <div>
                ...
                <select name="userRole" id="userRole">
                    ...
                    <option value="2" ${user.userRole==2 ? 'selected' : '' }>经理</option>
                    <option value="3" ${user.userRole==3 ? 'selected' : '' }>普通用户</option>
                </select>
                <font color="red"></font>
            </div>
